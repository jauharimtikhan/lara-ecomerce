...
return [
    ...
    | ukuran. Anda bebas mengubah setiap pesan ini di sini.
    |
    */
    ...
    'password' => [
        ...
        'uncompromised' => 'Kolom :attribute yang diberikan sudah pernah muncul dalam kebocoran data. Silakan pilih :attribute yang berbeda.',
    ],
    ...
    |--------------------------------------------------------------------------
    |
    | Anda dapat menentukan pesan validasi khusus untuk atribut menggunakan
    | konvensi "attribute.rule" untuk menamai baris. Hal ini memudahkan
    | penentuan pesan khusus untuk aturan atribut tertentu.
    |
    */
    ...
    | "email". Ini hanya membantu membuat pesan kita lebih ekspresif.
    |
    */

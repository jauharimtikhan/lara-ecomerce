        ...
        <div class="flex items-center justify-between">
            <div class="flex items-center justify-start">
                ...
                <a href="#" class="flex ml-2 md:mr-24">
                    <img src="{{ asset('frontend/img/logo.png') }}" class="h-8 mr-3" alt="Lara Ecomerce Logo" />
                    <span
            ...
            <div class="flex items-center">
                ...
                <!-- Dropdown menu -->
                <div class=" z-50 hidden max-w-xl my-4 overflow-hidden text-base list-none bg-white divide-y divide-gray-100 rounded shadow-lg dark:bg-gray-700 dark:divide-gray-600"
                    id="apps-dropdown">
                    <div
                    ...
                    <div>
                        <button type="button"
                            ...
                            <img class="w-8 h-8 rounded-full"
                                src="https://ui-avatars.com/api/?rounded=true&background=000000&color=d97706&name={{ ucfirst(Auth::user()->name) }}&length=1"
                                alt="user photo">
                        </button>
                    </div>
                    <!-- Dropdown menu -->

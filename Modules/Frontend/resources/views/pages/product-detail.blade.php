        ...
        <div class="max-w-screen-xl px-4 mx-auto 2xl:px-0">
            <div class="lg:grid lg:grid-cols-2 lg:gap-8 xl:gap-1 md:grid md:grid-cols-2 md:gap-12">
                <div class="shrink-0 max-w-md lg:max-w-lg mx-auto">
                    ...
                    <div class="py-10 w-full drop-shadow-lg ">
                        <h1 class="text-2xl font-semibold text-gray-900 dark:text-white mb-4">Galleri Produk</h1>
                        <div id="controls-carousel-{{ $product->id }}" class="relative w-full" data-carousel="static">
                            <!-- Carousel wrapper -->

<div id="global-search" wire:ignore.self
    class="fixed top-0 hidden py-3 left-1/2 transform bg-gray-300 dark:bg-gray-800  -translate-x-1/2 mt-[4.8rem] w-full z-50 px-3 max-w-screen-xl ">
    <form class="flex items-center w-full px-4">
        ...
        <div class="relative w-full ">
            ...
            <div id="global-search-result" class="absolute hidden translate-y-[110%] w-full  inset-y-0"
                wire:ignore.self>

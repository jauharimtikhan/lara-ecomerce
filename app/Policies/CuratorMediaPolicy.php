...
class CuratorMediaPolicy
{
     ...
     */
    public function view(User $user, CuratorMedia $curatorMedia): bool
    {
     ...
     */
    public function update(User $user, CuratorMedia $curatorMedia): bool
    {
     ...
     */
    public function delete(User $user, CuratorMedia $curatorMedia): bool
    {
     ...
     */
    public function forceDelete(User $user, CuratorMedia $curatorMedia): bool
    {
     ...
     */
    public function restore(User $user, CuratorMedia $curatorMedia): bool
    {
     ...
     */
    public function replicate(User $user, CuratorMedia $curatorMedia): bool
    {
